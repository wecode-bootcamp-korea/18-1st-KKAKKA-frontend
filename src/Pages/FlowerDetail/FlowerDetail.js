    ...
    return (
      <section className="detailContainer">
        <ul className="categoryNav">
          ...
          <li>
            <Link to="/subscribe-list">꽃다발</Link>
          </li>
          <li>
            <Link to="subscribe-detail">{subscribeList.name}</Link>
          </li>
        </ul>
        <div className="detailContents">
          ...
          <div className="productDetailRight">
            <ProductInfo
              ...
              detail={subscribeList.detail}
              name={subscribeList.name}
              size={subscribeList.size}
              origin_price={subscribeList.origin_price}
              discount_rate={subscribeList[0].discount_rate}
              discounted_price={subscribeList.discounted_price}
